...
1.) When your account is created, you can create a new repository if you want to start writing your website yourself, and name it "[username].github.io." At this point I had already done some research and found that I wanted the al-folio theme, and alshedivat makes it really easy to clone the repository by clicking a link in the INSTALL.md file `https://github.com/new?template_name=al-folio&template_owner=alshedivat`.
...
Wait until the GitHub action with subtitle Deploy site finishes (check your repository Actions tab), which takes ~4 min. Now, in addition to the master branch, your repository has a newly built gh-pages branch.
