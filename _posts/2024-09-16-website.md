...
12.) Due to me not using all of the pages on the site, and not needing some .md files in the root of the Main branch, I deleted a bunch of stuff to simplify my experience moving forward. This is something that others may not care for, but again, I value simplicity. This process took me some time, but I ultimately got it done.

13.) Now that the site existed, the very final step of the process was using my domain as the forward facing URL. I think it is just a cool cherry on top of what I do and represent, as a unique and clever staple that resembles a phishing site.
