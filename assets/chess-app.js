 ...
 * (loaded as an ES module straight from jsDelivr's `+esm` build, so no
 * bundler step is needed on a plain Jekyll/GitHub Pages site).
 *
...
class ChessApp {
  ...
  revealSecret() {
    ...
    const SECRET_MESSAGE =
      "gg. you beat the machine. every good hacker knows the real flag was never in the obvious place \u2014 M";
